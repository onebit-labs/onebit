...
} from './interfaces/IVaultAddressesProviderRegistry.sol';
import {Errors} from './libraries/helpers/Errors.sol';

/**
 * @title VaultAddressesProviderRegistry contract
 * @dev Main registry of VaultAddressesProvider of multiple Aave protocol's markets
...
contract VaultAddressesProviderRegistry is Ownable, IVaultAddressesProviderRegistry {
   ...
   * @param provider The address of the new VaultAddressesProvider
  ...
  /**
   * @dev Removes a VaultAddressesProvider from the list of registered addresses provider
  ...
  /**
   * @dev Returns the id on a registered VaultAddressesProvider
   * @return The id or 0 if the VaultAddressesProvider is not registered
   */
