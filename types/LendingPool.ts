...
export declare namespace DataTypes {
  ...
  export type ReserveDataStruct = {
    ...
    redemptionEndTimestamp: PromiseOrValue<BigNumberish>;
...
export interface LendingPoolInterface extends utils.Interface {
  functions: {
    ...
    "initializeNextPeroid(uint16,uint16,uint128,uint40,uint40,uint40,uint40)": FunctionFragment;
